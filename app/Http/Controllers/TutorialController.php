...
class TutorialController extends Controller
{
    public function penjadwalan_tutorial(Request $request)
    {
        ...
        $paginator = $query->orderBy('id', 'asc')->paginate(20); // Ensure paginate() is used

        $props = [
            'title' => 'Penjadwalan Tutorial',
            'active' => 'Tutorial',
            'paginator' => $paginator, // Pass paginator to the view
            'search' => $request->get('search')
        ];
    ...
    public function cek_jadwal_tutorial(Request $request)
    {
        ...
        $paginator = $query->orderBy('tutor', 'asc')->paginate(20); // Ensure paginate() is used
