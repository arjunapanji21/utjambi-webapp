        ...
        <table class="table w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="sticky top-0 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                {{-- <tr>
                    ...
                    <th scope="col" class="px-4 py-3 uppercase">Kode Tutor</th>
                    <th scope="col" class="px-4 py-3 uppercase">Kode Tutorial</th>
                    <th scope="col" class="px-4 py-3 uppercase">Kode Kelas</th>
                    <th scope="col" class="px-4 py-3 uppercase">Kode Jadwal</th>
                    <th scope="col" class="px-4 py-3 uppercase">Kode Lokasi</th>
                    <th scope="col" class="px-4 py-3 uppercase">Tgl. Mulai</th>
                    <th scope="col" class="px-4 py-3 uppercase">Tgl. Selesai</th>
                    <th scope="col" class="px-4 py-3 uppercase">Prediksi</th>
                    <th scope="col" class="px-4 py-3 uppercase">Link</th>
                    <th scope="col" class="px-4 py-3 uppercase">Email Pembuat Teams</th>
                </tr> --}}
                <tr>
                    <th scope="col" class="px-4 py-3 uppercase">#</th>
            ...
            <tbody>
                ...
                {{-- <tr class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3">{{$row->tutorial->masa}}</td>
                    <td class="px-4 py-3">{{$row->peserta->nim}}</td>
                    <td class="px-4 py-3">{{$row->tutorial->kode_tutor}}</td>
                    <td class="px-4 py-3">{{$row->tutorial->kode_tutorial}}</td>
                    <td class="px-4 py-3">{{$row->tutorial->kode_kelas}}</td>
                    <td class="px-4 py-3">{{$row->tutorial->kode_jadwal}}</td>
                    <td class="px-4 py-3">{{$row->kode_lokasi}}</td>
                    <td class="px-4 py-3">{{date('d/m/Y', strtotime($row->tutorial->tgl_mulai))}}</td>
                    <td class="px-4 py-3">{{date('d/m/Y', strtotime($row->tutorial->tgl_selesai))}}</td>
                    <td class="px-4 py-3">{{$row->tutorial->prediksi}}</td>
                    <td class="px-4 py-3">{{$row->tutorial->link}}</td>
                    <td class="px-4 py-3">{{$row->tutorial->email_pembuat_teams}}</td>
                </tr> --}}
                <tr class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3">{{count($row->groupBy('penjadwalan_tutorial_id'))}}</td>
                </tr>
                @endforeach
                @endif
            </tbody>
