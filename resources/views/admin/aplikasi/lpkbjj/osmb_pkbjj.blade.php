...
<div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
    ...
    <div class="overflow-auto min-h-32 max-h-[64vh] px-4">
        <table class="table w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="sticky top-0 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-4 py-3 uppercase">Batch</th>
                    <th scope="col" class="px-4 py-3 uppercase">Mahasiswa</th>
                    <th scope="col" class="px-4 py-3 uppercase">OSMB</th>
                    <th scope="col" class="px-4 py-3 uppercase">PKBJJ</th>
...
<div id="modal-import" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{route('admin.lpkbjj.osmb_pkbjj_import')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Import File Excel Peserta OSMB-PKBJJ</label>
                        ...
                        <a download href="{{asset('templates/format_import_data_wtku.xlsx')}}" class="text-xs italic hover:underline text-primary-600">*Download Template Excel</a>
                    </div>
                </div>
