    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" action="{{route('admin.data.peserta_ujian.import')}}" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="text-primary-700 w-full text-center items-center bg-primary-100 hover:bg-primary-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-200 dark:hover:bg-blue-300 dark:focus:ring-blue-800">
                    Submit
                </button>
            </form>
        </div>
