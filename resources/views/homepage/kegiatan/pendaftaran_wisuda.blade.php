    ...
    <div class="py-8 px-6 max-w-screen-xl mx-auto">
        ...
        <div class="space-y-4">
            <p class="font-normal text-gray-500 lg:text-lg text-justify dark:text-gray-400">
                ...
                diberikan langsung pada saat hari wisuda. Peserta wisuda adalah yang telah terjaring Yudisium dan Ijazah sudah sampai di kantor Universitas Terbuka Daerah Jambi.
            </p>
        </div>
                ...
                <ol class="relative border-s border-gray-200 dark:border-gray-700 list-none">
                    <li class="mb-10 ms-6">
                        ...
                        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Selamat, kamu telah
                            terjaring yudisium masa {{$calon_wisuda->masa_yudisium}}. Silahkan cetak LIP Wisuda melalui tombol dibawah ini. <span class="text-red-600 text-sm italic">*(Jika tombol cetak LIP belum muncul pada laman aksi, silahkan menunggu paling lambat 3x24 Jam)</span></p>
                    ...
                    <li class="mb-10 ms-6">
                        ...
                        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Silahkan bergabung kedalam WAG resmi Wisuda UT Jambi Periode I Tahun 2025 melalui tombol di bawah ini.</p>
                            <a href="https://chat.whatsapp.com/DqJClLY57AWGXit3EwFIj0" target="_blank"
                    ...
                    @elseif(!$calon_wisuda->konfirmasi_lip && $calon_wisuda->bukti_pembayaran != null && $calon_wisuda->bukti_pembayaran != 'Request LIP')
                    <li class="mb-10 ms-6">
                        <span
